...
if object_id('portfolios') is not null
...
begin
	...
	insert into fund(
		FundCode, FundName, CreatedDate, FundManager
	)
	values(
		@FundCode, @FundName, @CreatedDate, @FundManager
	)
...
begin
	...
	begin
		select FundId, FundCode, FundName, FundManager, CreatedDate, ModifiedDate
		from fund
		where FundCode=@FundCode
	end
	else
